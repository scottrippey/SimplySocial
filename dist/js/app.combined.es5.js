...
angular.module("app-components.js", ["feed-item.js", "list-filter.js", "main-banner.js", "title-bar.js", "user-feed.js", "write-something.js"]);
/* This file was generated by [build-angular.js] */
...
angular.module("user-feed.js", []).directive("userFeed", [function () {
	return {
		...
		controller: function controller() {
			...
			angular.extend(vm, {
				feedItems: [{ message: "Post 1" }, { message: "Post 2" }, { message: "Post 3" }, { message: "Post 4" }, { message: "Post 5" }, { message: "Post 6" }, { message: "Post 7" }]
			});
		}
	};
}]);
